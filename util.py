...
[Ctrl+Z] Exit Launch Anything
        ...
        if opt == "print(tiny_info)": print(tiny_info)
        if opt == "print(all_info)": print(all_info)
        if opt == "print(osn)": print(osn)
        if opt == "print(hostIP)": print(hostIP)
        if opt == "do()": do()
        if opt == "os": print(os)
        if opt == "print(battery)": print(battery)
        if opt == "winver": opt = "winver"
        if opt == "29":
          import webbrowser
